...
Countermeasures to this kind of mass balance fraud are described in the UNTP [chain of custody](/docs/0.6.0/design-patterns/ChainOfCustody) best practices page.

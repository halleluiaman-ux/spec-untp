...
After creating a new version, update the version configuration in `src/config/versions.ts` to define:

- Version label and path
- Banner type (WIP, MAINTAINED, LATEST_RELEASE, UNMAINTAINED)
- Suitable use case (TESTING, PILOTS, PRODUCTION)

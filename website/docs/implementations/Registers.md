...
| [Open Supply Hub](#open-supply-hub)                                                 | Organisations, Locations                   | DFR, DIA   | planned          |
...
- UNTP commitment made on: 30-March-2026
- Registration Country: USA
- Operating Countries: Global

| Logo                                                 | Implementation Statement                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| ---------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![Logo](/img/implementations/opensupplyhub/logo.png) | Open Supply Hub maintains the world’s largest open registry of global manufacturing facilities and provides free, unique facility identifiers (OS IDs) used across supply chains. Because OS IDs are free and openly accessible, they help ensure that all facilities—including SMEs—can participate in emerging digital product passport and traceability ecosystems. Implementing the UN Transparency Protocol (UNTP) will enable OS IDs to function as resolvable digital identity anchors for facilities, supporting interoperable data exchange, reducing duplication across systems, and strengthening reliable facility identification across the global supply chain. |

#### Registrered Identifier Schemes

| Scheme       | Description | UNTP Version(s) | Implementation Date | Test Report |
| ------------ | ----------- | --------------- | ------------------- | ----------- |
| Organisation | TBA         | IDR v1.0        | TBA                 | TBA         |
| Locations    | TBA         | IDR v1.0        | TBA                 | TBA         |

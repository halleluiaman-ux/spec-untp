...
Please list any industry associations of which you are a member and which may be a focal point for a UNTP [community activation program](https://spec-untp-fbb45f.opensource.unicc.org/docs/business-case/CommunityActivationProgram). Also please indicate which (if any) [UNTP industry extensions](https://spec-untp-fbb45f.opensource.unicc.org/docs/extensions/) you plan to implement
...
Authoritative Registers of product, facility, or organisation identifiers may register their intent to implement the UNTP [Identity Resolver](https://spec-untp-fbb45f.opensource.unicc.org/docs/specification/IdentityResolver) specification here.

...
- A [Value Assessment Framework](/docs/0.6.0/business-case/ValueAssessmentFramework) that will collect performance metrics from implementers to track UNTP impact on UN Sustainable Development Goals.

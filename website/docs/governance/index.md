...
- A [Value Assessment Framework](../business-case/ImpactAssessmentFramework.md) that will collect performance metrics from implementers to track UNTP impact on UN Sustainable Development Goals.
- An [extensions methodology](../tools-and-support/ExtensionsMethodology.md) and governance framework that provides an incentive for implementations across entire communites led by member associations.
...
- UNTP **Community Extensions Working Groups** develop industry and/or geography specific extensions of UNTP following a [methodology](../tools-and-support/ExtensionsMethodology.md) that ensures all extensions remain interoperable with UNTP core implementations and any other industry extension.
...
Looks after the maintenance of the Digital Conformity Credential (DCC) and the Conformity Vocabulary Catalog (CVC). This is all about conformity schemes, and the digitally referenceable criteria that are referenced by DCC assessments and the “Claims” in DPPs and DFRs. [Terms of reference and meetings](conformityGroup.md)
...
## UNTP General Update Meetings

The working groups listed above are primarily targeted at active contributors who will share the work of developing and maintaining the UNTP specifications. However there is a much broader group of active observers who are interested to stay in touch with UNTP developments but are not yet ready to join working groups to contribute to ongoing development.

Anyone interested in UNTP is welcome to join the [monthly general update meetings](generalUpdates.md).
